...
useAL = True
names = [f'bootstrapped_CL_shrink_perturb_lam_0.5_random_replaysize_0.5_useAL_{useAL}',
        f'bootstrapped_CL_shrink_perturb_lam_0.5_random_replaysize_1_useAL_{useAL}',
        f'bootstrapped_CL_shrink_perturb_lam_1_random_replaysize_0.5_useAL_{useAL}',
        f'bootstrapped_CL_shrink_perturb_lam_1_random_replaysize_1_useAL_{useAL}',
        f'bootstrapped_CL_shrink_perturb_lam_0.5_individual_replaysize_0.5_useAL_{useAL}',
        f'bootstrapped_CL_shrink_perturb_lam_0.5_individual_replaysize_1_useAL_{useAL}',
        f'bootstrapped_CL_shrink_perturb_lam_1_individual_replaysize_0.5_useAL_{useAL}',
        f'bootstrapped_CL_shrink_perturb_lam_1_individual_replaysize_1_useAL_{useAL}']
...
#    fig, ax = plt.subplots(1,2, figsize=(20,10))
    ...
    if acquis == 'random':
        ...
        color=colors_2[i-4] 
        marker ='*'
    ax.plot(range(len(val_mean)),val_mean, label=label,color=color,lw=4)
